...
TOKEN = '6690808385:AAFTaR58ddrL6K-9qKpChLPENPJpoiDqYpg'
...
FORWARD_CHANNEL_ID = -1002170866351
CHANNEL_ID = -1002170866351
error_channel_id = -1002170866351
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*@Mavi707*", parse_mode='Markdown')
    else:
